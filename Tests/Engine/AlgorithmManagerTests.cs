...
namespace QuantConnect.Tests.Engine
{
    ...
    public class AlgorithmManagerTests
    {
        ...
        public void TestAlgorithmManagerSpeed()
        {
            ...
            MockDataFeed feed = new MockDataFeed();
            var transactions = new NullTransactionHandler();
            ...
            var seconds = feed.Stopwatch.Elapsed.TotalSeconds;
            Console.WriteLine("COUNT: " + feed.Count + "  KPS: " + thousands/seconds);
        }
        ...
        class MockDataFeed : IDataFeed
        {
            ...
            public IEnumerator<TimeSlice> GetEnumerator()
            {
                ...
                do
                {
                    ...
                    if (_frontierUtc.Month != timeSlice.Time.Month)
                    {
                        Console.WriteLine($"DATAFEED: FRONTIER: {_frontierUtc}  COUNT: {Count}  KPS: {Count/1000d/Stopwatch.Elapsed.TotalSeconds}");
                    }
                }
